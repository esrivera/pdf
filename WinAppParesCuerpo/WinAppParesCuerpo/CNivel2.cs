...
namespace WinAppParesCuerpo
{
    class CNivel2
    {
        ...
        public void memoria(Panel pnlNivel, Timer timer1, Timer timer2, PictureBox picCaraFeliz, PictureBox picCaraSorprendida, 
            frmNivel2 nivel2, PictureBox V1, PictureBox V2, PictureBox V3){
                    ...
                    if (CartasSeleccionadas.Count < 2)
                    {
                        ...
                        if (CartasSeleccionadas.Count == 2)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    SoundPlayer sndPlayer1 = new SoundPlayer(WinAppParesCuerpo.Properties.Resources.Ojo);
                                    sndPlayer1.Play();
                                }
                                ...
                                if (CantidadDeCartasVolteadas > 3)
                                {
                                    ...
                                    nivel2.Close();
                                    frmNivel3 frmNivel3 = new frmNivel3();
                                    frmNivel3.Show();
                                }
                            }
                        }
